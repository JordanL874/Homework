...
```SQL
SELECT TopSpeed, round(TopSpeed * 0.62137119, 1)
FROM evCars 
...
UPDATE evCars 
SET 
    TopSpeed = round(TopSpeed * 0.62137119, 1)
...
```SQL
SELECT Range, round(Range * 0.62137119, 1)
FROM evCars 
```
...
```SQL
-- SELECT FastCharge, round(FastCharge * 0.62137119, 1)
-- FROM evCars 

-- UPDATE evCars 
-- SET 
-- FastCharge = round(FastCharge * 0.62137119, 1)
...
- If the PowerTrain equals _______All Wheel Drive_______ then I want you to change the value to 'AWD'
- If the PowerTrain equals Rear Wheel Drive_______ then I want you to change the value to 'RWD'
- If the PowerTrain equals Front Wheel Drive_________ then I want you to change the value to 'FWD'
<br>
